    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="torbe.php">Torbe</a>
    ...
    <tbody>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td colspan='4'><strong>" . htmlspecialchars($row['ime']) . "</strong></td>"; 
                echo "</tr>";
                echo"<tr>";
                echo "<td>" . htmlspecialchars($row['cena']) . " EUR</td>";
                "</tr";
                
                echo "<td><img src='" . htmlspecialchars($row['slika']) . "' alt='" . htmlspecialchars($row['ime']) . "' class='img-fluid'></td>"; 
                
                echo "<td>" . htmlspecialchars($row['opis']) . "</td>";
            }
        } else {
            echo "<tr><td colspan='5'>Nema proizvoda u bazi.</td></tr>";
        }
